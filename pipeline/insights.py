...
### 6. 搜索建议
生成 ** 2个概念词（concept_queries）**，用于后续联网检索延伸阅读资料：
    - 每个概念词应是**专有名词、特定事件、具体人名、机构名、产品名或核心操作术语**，避免过于宽泛的普通名词，根据文章主旨适当修改（如「黄金」在讲投资的文章中可修改为「黄金期货」，在讲工业的文章可修改为「黄金提纯」，如果是黄金的科普文章，则不修改保持「黄金」）
    - 修改词要克制，保持简洁性，但整体需有区分度和检索意义，词的长度为2-5个字
    - 必须聚焦于本段特有内容并且符合全文主旨，舍弃非主旨内容（如插播广告、特殊说明等）
